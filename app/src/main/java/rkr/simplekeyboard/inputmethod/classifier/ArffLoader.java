    ...
    public void JsonToInstance(JSONObject jo) {
        if (this.structure != null) {
            ...
            try {
                ...
                newdata.setValue(3, (int) jo.get("vectorCoordX"));
                newdata.setValue(4, (int) jo.get("vectorCoordY"));
                ...
                newdata.setValue(8, (double) ((JSONObject)jo.get("AverageRotationVectorOnPress")).get("x"));
                newdata.setValue(9, (double) ((JSONObject)jo.get("AverageRotationVectorOnPress")).get("y"));
                newdata.setValue(10, (double) ((JSONObject)jo.get("AverageRotationVectorOnPress")).get("z"));
                newdata.setValue(11, (double) ((JSONObject)jo.get("AverageRotationVectorOnRelease")).get("x"));
                newdata.setValue(12, (double) ((JSONObject)jo.get("AverageRotationVectorOnRelease")).get("y"));
                newdata.setValue(13, (double) ((JSONObject)jo.get("AverageRotationVectorOnRelease")).get("z"));
